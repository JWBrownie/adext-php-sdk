...
namespace Adext\Authentication;
use Adext\AdextApp;
use Adext\AdextClient;
...
class OAuth2Client
{
     ...
     */
    const BASE_AUTHORIZATION_URL = 'https://adext.com';
    /**
     * The AdextApp entity.
     *
     * @var AdextApp
     ...
     *
     * @var AdextRequest|null
     */
    protected $lastRequest;

    /**
     * @param AdextApp $app
     * @param AdextClient $client
     * @param string|null $version The version of the Graph API to use.
     */
    public function __construct(AdextApp $app, AdextClient $client, $version = null)
    {
        $this->app = $app;
        $this->client = $client;
        $this->graphVersion = $version ?: Adext::DEFAULT_VERSION;
    }

    /**
     * Returns the last AdextRequest that was sent.
    ...
    public function debugToken($accessToken)
    {
        ...
        $this->lastRequest = new AdextRequest(
            $this->app,
    ...
    public function getCodeFromLongLivedAccessToken($accessToken, $redirectUri = '')
    {
        ...
        if (!isset($data['code'])) {
            throw new AdextSDKException('Code was not returned from API.', 401);
        }
        return $data['code'];
    }
    ...
    protected function requestAnAccessToken(array $params)
    {
        ...
        if (!isset($data['access_token'])) {
            throw new AdextSDKException('Access token was not returned from API.', 401);
        }
        ...
        if (isset($data['expires'])) {
            ...
            // See: https://developers.Adext.com/docs/Adext-login/access-tokens#long-via-code
