...
class PseudoRandomStringGeneratorFactory
{
     ...
     *
     * @throws InvalidArgumentException If the pseudo random string generator must be set to "random_bytes", "mcrypt", "openssl", or "urandom", or be an instance of Adext\PseudoRandomString\PseudoRandomStringGeneratorInterface.
     *
    ...
    public static function createPseudoRandomStringGenerator($generator)
    {
        ...
        throw new InvalidArgumentException('The pseudo random string generator must be set to "random_bytes", "mcrypt", "openssl", or "urandom", or be an instance of Adext\PseudoRandomString\PseudoRandomStringGeneratorInterface');
    }

    /**
     * Detects which pseudo-random string generator to use.
     *
     * @throws AdextSDKException If unable to detect a cryptographically secure pseudo-random string generator.
     *
     * @return PseudoRandomStringGeneratorInterface
     */
    private static function detectDefaultPseudoRandomStringGenerator()
    {
        ...
        throw new AdextSDKException('Unable to detect a cryptographically secure pseudo-random string generator.');
    }
}
